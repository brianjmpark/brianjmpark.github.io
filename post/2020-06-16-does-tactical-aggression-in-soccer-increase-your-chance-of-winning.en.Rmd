...
data2b <- data2 %>% filter(B365H %in% c(1.50,1.99))
data2c <- data2 %>% filter(B365H %in% c(2.00,2.49))
data2d <- data2 %>% filter(B365H %in% c(2.50,2.99))
data2e <- data2 %>% filter(B365H %in% c(3.00,3.49))
data2f <- data2 %>% filter(B365H %in% c(3.50,3.99))
```
